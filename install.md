...
To move beyond notebook prototyping, all reusable code should go into the `proyecto_final/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `proyecto_final` folder and use the modules inside your notebooks :
...
```python
from proyecto_final.utils.paths import data_dir
data_dir()
```
